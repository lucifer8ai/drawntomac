...
class ServerSentEventHandler extends import_HttpHandler.HttpHandler {
  ...
  constructor(path, resolver) {
    ...
    super("GET", path, async (info) => {
      ...
      const emitter = new import_strict_event_emitter.Emitter();
...
const kClientEmitter = /* @__PURE__ */ Symbol.for("kClientEmitter");
...
const kRequest = /* @__PURE__ */ Symbol("kRequest");
const kReconnectionTime = /* @__PURE__ */ Symbol("kReconnectionTime");
const kLastEventId = /* @__PURE__ */ Symbol("kLastEventId");
const kAbortController = /* @__PURE__ */ Symbol("kAbortController");
const kOnOpen = /* @__PURE__ */ Symbol("kOnOpen");
const kOnMessage = /* @__PURE__ */ Symbol("kOnMessage");
const kOnAnyMessage = /* @__PURE__ */ Symbol("kOnAnyMessage");
const kOnError = /* @__PURE__ */ Symbol("kOnError");
